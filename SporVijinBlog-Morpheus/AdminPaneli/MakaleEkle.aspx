<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPaneli/YoneticiMaster.Master" AutoEventWireup="true" CodeBehind="MakaleEkle.aspx.cs" Inherits="SporVijinBlog_Morpheus.AdminPaneli.MakaleEkle" ValidateRequest="false" %>
        ...
        <div class="sol">
            ...
            <div class="formIcerik" style="min-height: 420px;">
                ...
                <div class="satir" style="margin-top: 20px; margin-bottom:20px;">
                    <asp:LinkButton ID="lbtn_makaleEkle" runat="server" Text="Makale Ekle" CssClass="buton" OnClick="lbtn_makaleEkle_Click"></asp:LinkButton>
                </div>
